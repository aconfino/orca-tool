...
bot.inject.cache.getElement = function(a, b) {
  ...
  var e = d[a];
  if(e.nodeType != goog.dom.NodeType.ELEMENT && goog.object.containsKey(e, "document")) {
    if(e.closed) {
...
core.events.replaceText_ = function(a, b) {
  ...
  if(bot.dom.isElement(a, goog.dom.TagName.BODY)) {
    ...
    goog.userAgent.GECKO && bot.userAgent.isVersion(8) ? XPCNativeWrapper(a).value = d : a.value = d
  }
  try {
